        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Price */}
              <div className="mb-6">
                <span className="text-3xl font-light text-[#e94491]">${product.current_price.toFixed(2)}</span>
                {product.discount_percentage > 0 && (
                  <span className="text-xl text-gray-400 line-through ml-3">${product.base_price.toFixed(2)}</span>
                )}
              </div>
            </div>
